...
const CryptoDetailes = () => {
  ...
  const [timesPeriod, setTimesPeriod] = useState('7d')
  const {data, isFetching} = useGetCryptoDetailsQuery(coinId)
  const {data: coinHistory} = useGetCryptoHistoryQuery({coinId, timesPeriod})
  ...
  const stats = [
    ...
    { title: '24h Volume', value: `$ ${cryptoDetails?._24hVolume && millify(cryptoDetails?._24hVolume)}`, icon: <ThunderboltOutlined /> },
  ...
  return (
    <Col className='coin-detail-container'>
      ...
      <Select
        ...
        onChange={(value) => setTimesPeriod(value)}
      >
